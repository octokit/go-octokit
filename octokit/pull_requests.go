...
type PullRequest struct {
	*Resource
	...
	URL               hypermedia.Hyperlink `rel:"self" json:"url,omitempty"`
	...
	ReviewCommentURL  hypermedia.Hyperlink `rel:"review_comment" json:"review_comment_url,omitempty"`
	CommentsURL       hypermedia.Hyperlink `rel:"comments" json:"comments_url,omitempty"`
	StatusesURL       hypermedia.Hyperlink `rel:"statuses" json:"statuses_url,omitempty"`
